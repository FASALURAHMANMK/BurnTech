  ...
  class MapTab extends StatefulWidget {
    ...
    const MapTab({Key? key, required this.camps, required this.arts})
        : super(key: key);
  ...
  class _MapTabState extends State<MapTab> {
    ...
    Future<void> _updateInfoWindowOffset(MapProvider mapProvider) async {
      if (mapProvider.mapController != null &&
          mapProvider.selectedMarkerPosition != null) {
        ...
        child: Consumer<MapProvider>(
          builder: (context, mapProvider, child) {
            ...
            if (widget.camps.length == 1 &&
                ...
                (widget.camps[0].latitude != 0.0 ||
                    widget.camps[0].longitude != 0.0)) {
              initialCenter =
                  LatLng(widget.camps[0].latitude!, widget.camps[0].longitude!);
              initialZoom = 18.0;
              showmyloc = false;
            }
            ...
            if (initialCenter == null && widget.arts.length == 1) {
              ...
              if (art.location != null &&
                  ...
                  (art.location!.gpsLatitude != 0.0 ||
                      art.location!.gpsLongitude != 0.0)) {
                initialCenter = LatLng(
                    art.location!.gpsLatitude!, art.location!.gpsLongitude!);
                initialZoom = 18.0;
