...
class ArtDialog_Buy_Camp extends StatelessWidget {
  final CampModel camp;
  final UserProvider userProvider;

  const ArtDialog_Buy_Camp({Key? key, required this.camp, required this.userProvider})
      : super(key: key);
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                userProvider.updateTokens(camp);
