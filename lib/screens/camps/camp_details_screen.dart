                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                events.isEmpty
                                    ...
                                    : ListView.builder(
                                        // Important to avoid "unbounded height" error:
                                        shrinkWrap: true,
                                        physics:
...
class _EventCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    // Combine all event occurrences into a simple text (if desired)
    ...
    borderRadius: BorderRadius.circular(18), // Change 20.0 to your desired radius
      ...
      child: ListTile(
        ...
        // Add a trailing icon or something else if you want
        trailing: const Icon(Icons.arrow_forward_ios, size: 16),
        onTap: () {
          // Navigate to an EventDetailScreen if you have one
          // e.g. Navigator.push(...)
        },
      ),
    );
  ...
  /// Simple date formatting. Feel free to use intl package for a better format.
