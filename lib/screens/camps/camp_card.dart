...
class CampCard extends StatelessWidget {
  ...
  // Placeholder functions for computing distances.
  ...
  Widget build(BuildContext context) {
    // Determine if the current user has favorited this camp or has a token.
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    Text(getWalkingDistance(), style: const TextStyle(color: Colors.green)),
                  ],
                ),
                Row(
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    ...
                    const SizedBox(width: 4),
                    Text(getCyclingDistance(), style: const TextStyle(color: Colors.green)),
                  ],
                ),
                Row(
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    ...
                    const SizedBox(width: 4),
                    Text(getDrivingDistance(), style: const TextStyle(color: Colors.green)),
                  ],
                ),
              ],
            ),
            const SizedBox(height: 8),
            // Row for map, ticket, and favorite actions.
            Wrap(
              spacing: 12,
              runSpacing: 8,
              crossAxisAlignment: WrapCrossAlignment.center,
