...
class HomeTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Schedule the fetchUser call after the first frame.
                  ...
                  ExpandableWalletCard(
                    ...
                    itemBuilder: (context, item) {
                      if (item is EventModel) {
                        // For simplicity, display the first occurrence start time if available.
                        ...
                        return Card(
                          ...
                          child: ListTile(
                            leading: const Icon(Icons.event_available,color: desertOrange),
                            title: Text(item.title ?? "Untitled Event",style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold)),
                            subtitle: Text("Starts at: $startTime",style: TextStyle(color: Colors.green)),
                          ),
                        );
                      }
                      return const SizedBox.shrink();
