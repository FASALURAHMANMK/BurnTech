      ...
      MultiProvider(
        providers: [
          ChangeNotifierProvider(
              create: (_) => AuthProvider()..checkUidInPrefs()),
          ...
          ChangeNotifierProvider<CampDetailProvider>(
              create: (_) => CampDetailProvider()),
          ChangeNotifierProvider<ArtDetailProvider>(
              create: (_) => ArtDetailProvider()),
          ChangeNotifierProvider<ChatProvider>(create: (_) => ChatProvider()),
          ChangeNotifierProvider<favCampProvider>(
              create: (_) => favCampProvider()),
          ChangeNotifierProvider<favArtProvider>(create: (_) => favArtProvider()),
          ChangeNotifierProvider<MBTilesProvider>(
              create: (_) => MBTilesProvider()),
        ],
        child: const MyApp(),
      ),
    );
